...
# IRAN_PLATE_DIR = os.getenv("IRAN_PLATE_DIR")
...
#     # تحميل الخط
#     FONT_PATH = r"C:\Users\DELL\Documents\Automation\final2\SwaPro\Amiri-Bold.ttf"
...
#     digits_font_size = find_max_font_size(digits_arabic, digit_area, spacing=10, font_path=FONT_PATH)
#     letters_font_size = find_max_font_size(arabic_letters_list, letter_area, spacing=10, font_path=FONT_PATH)

#     digits_font = ImageFont.truetype(FONT_PATH, digits_font_size)
#     letters_font = ImageFont.truetype(FONT_PATH, letters_font_size)
...
#     # 1️⃣ تحميل الخلفية
#     background_path = os.getenv("IRAQ_BACKGROUND_TEMPLATE")
#     background = Image.open(background_path).convert("RGB")
#     draw = ImageDraw.Draw(background)

#     # 2️⃣ إعداد الخط
#     font_path = os.getenv("FONT_IRAQ")
...
#     font_path = os.getenv("FONT_QATAR")
#     # urllib.request.urlretrieve(font_url, font_path)

#     background_path = os.getenv("QATAR_BACKGROUND")
#     background = Image.open(background_path).convert("RGB")
#     draw = ImageDraw.Draw(background)
...
#         while font_size > 0:
#             fnt = ImageFont.truetype(os.getenv("GERMANY_FONT"), font_size)
...
#             fnt = ImageFont.truetype(os.getenv("GERMANY_FONT"), size)
#             bbox = fnt.getbbox("X")
#             height = bbox[3] - bbox[1]
...
#     ger_plate = os.getenv("GERMANY_BACKGROUND")
...
#     saftey = os.getenv("LOGO_2013_GERMANY")
#     draw_image(img, (x, y + sticker1_y_offset), decal1_size, saftey, 0)
#     berlin = os.getenv("LOGO_BERLIN")
...
#     saftey = os.getenv("LOGO_2014_GERMANY")
#     draw_image(img, (x, y + sticker1_y_offset), decal1_size, saftey, 0)
#     bayern = os.getenv("LOGO_BAYERN")
...
@app.route("/test")
def test():
    return jsonify({"status": "success", "message": "Flask app is working!"})
